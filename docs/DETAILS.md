...
<p align="center">
  <img src="theme-ocean-dark.jpg" alt="Hyprland desktop" width="480" style="box-shadow: 0 10px 30px rgba(0,0,0,0.2)">
</p>
...
<p align="center">
  <img src="theme-selector.gif" alt="Selecting a theme with the command palette" style="box-shadow: 0 10px 30px rgba(0,0,0,0.2)">
</p>
...
<p align="center">
  <img src="command_palette.png" alt="Command palette" style="box-shadow: 0 10px 30px rgba(0,0,0,0.2)">
</p>
...
The desktop comes bundled with a selection of themes that can be selected through the command palette.
...
<p align="center">
  <img src="Fix-WindowsPrivacy.png" alt="Windows console running Fix-WindowsPrivacy.ps1" style="box-shadow: 0 10px 30px rgba(0,0,0,0.2)">
</p>
